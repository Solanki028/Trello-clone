...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-slate-950 overflow-hidden">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-12 flex-col justify-between">
        {/* Decorative elements */}
        ...
        <div className="relative">
          <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
            Organize your<br />work & life,<br />finally.
          </h2>
          <p className="text-xl text-white/80 max-w-md">
            Join millions of people who use Trello to manage projects, organize tasks, and build team collaboration.
          </p>
          
          {/* Feature pills */}
          <div className="flex flex-wrap gap-3 mt-8">
            {['Kanban Boards', 'Team Collaboration', 'Real-time Sync', 'Smart Automation'].map((feature) => (
              <span key={feature} className="px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm font-medium">
                {feature}
              </span>
            ))}
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              {['#f472b6', '#a78bfa', '#60a5fa', '#34d399'].map((color, i) => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-white/20" style={{ backgroundColor: color }} />
              ))}
            </div>
            <div className="text-white/80 text-sm">
              <span className="font-semibold text-white">10,000+</span> teams already on board
            </div>
          </div>
        </div>
      </div>
